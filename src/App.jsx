   ...
   return (
      <main className="w-full m-0 p-0">
         ...
         <div
            ...
            className="w-full flex justify-center mt-24 flex-col"
         >
         ...
         <div
            data-aos="fade-up"
            className="bg-[#F9F9F9] rounded-[70px] w-full px-20 py-32 mt-[100px]"
         >
            ...
            <div
               ...
               data-aos-easing="linear"
               data-aos-anchor-placement="bottom-bottom"
               className="flex items-end w-fit mx-auto gap-4 pl-8"
            >
       ...
       <div data-aos="fade-up"
         data-aos-duration="5000" className="flex flex-col px-16">
       ...
       <div data-aos="fade-up"
         data-aos-duration="5000" className="bg-[url('/bg.svg')] rounded-[70px] w-full pt-32 pb-[170px] mt-[100px] flex justify-between pl-14 h-fit ">
            ...
            <div className="relative">
               <img
                  ...
                  src="/lay.png"
                  alt=""
                  className="w-[1300px] ml-[70px]"
               />
           <p data-aos="fade-right" data-aos-duration="8000" className="text-[#ED4734] absolute font-black text-[380px] -mt-[270px]">
                  Ramos
               </p>
            </div>
         </div>
       ...
       <div data-aos="fade-up"
         data-aos-duration="5000" className="mt-[100px] px-16 ">
         ...
         {/* Get started */}
       <div data-aos="fade-up"
         data-aos-duration="5000" className="grid justify-items-center w-full mt-[100px]">
            <div
               data-aos="zoom-out"
               className="grid place-content-center p-[48px] rounded-[40px] bg-[#ED4734]  shadow-2xl shadow-[#ED4734]"
            >
       ...
       <footer  className="bg-black w-full mt-[100px] text-white px-16 pt-20">
         <div data-aos="fade-up"
           data-aos-duration="5000" className="flex justify-between items-center ">
           ...
           <p data-aos="fade-up"
             data-aos-duration="6000" className="text-[125px] font-[300]">Ramos®</p>
               <div className="gap-10 flex">
                  <p className="text-[#888888] text-[16px] font-[200]">
                     Privacy policy
                  </p>
                  <p className="text-[#888888] text-[16px] font-[200]">
                     License agreement
